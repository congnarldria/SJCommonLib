...
namespace SJCommonLib
{
    ...
    /// CallBack Args
    /// </summary>
    public class SJImageGrabbedEventArgs : EventArgs
    {
    ...
    public delegate void OnImageGrab(Object sender, SJImageGrabbedEventArgs e);
    ...
    {
        /// <summary>
        /// CalllBack += OnImageGrab(Object sender, SJImageGrabbedEventArgs e);
        /// </summary>
            ...
            else
            {
                ...
                for (int i = 0; i < stDevList.nDeviceNum; i++)
                {
                    ...
                    else if (MyCamera.MV_USB_DEVICE == stDevInfo.nTLayerType)
                    {
                        ...
                        TempdeviceList.Add(new MyCamera());
        ...
        private void ImageCallbackFunc(IntPtr pData, ref MyCamera.MV_FRAME_OUT_INFO_EX pFrameInfo, IntPtr pUser)
        {
            ...
            SJImageGrabbedEventArgs arg = new SJImageGrabbedEventArgs()
            {
