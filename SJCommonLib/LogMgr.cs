...
namespace SJCommonLib
{
    ...
    /// <summary>
    /// SJ Log Manager Send to "SJLog" named Window Title
    /// </summary>
    public class LogMgr
    {
        /// <summary>
        ...
        private static void PostLogMethod(string log, Exception e = null)
        {
            ...
            IntPtr maindHwnd = FindWindow(null, "SJLog");
        ...
        public static void SendLog(string log, Exception e = null, [CallerFilePath] string FileName = null ,[CallerLineNumber] int line = 0, [CallerMemberName] string caller = null)
        {
            StackFrame[] sfs = st.GetFrames();
            ...
            if (e != null)
            {
                ...
                Line = new StackTrace(e, true).GetFrame(efs.Length - 1).GetFileLineNumber();
                Function = new StackTrace(e, true).GetFrame(efs.Length - 1).GetMethod().Name;
                FileName = new StackTrace(e, true).GetFrame(efs.Length - 1).GetFileName();
                IError = "Err:";
            }
            else
            {
            ...
            IntPtr maindHwnd = FindWindow(null, "SJLog");
            string strSend = "App" + "," + log + "," + FileName + "," + Function + "," + IError + Line + "App" + "," + log + "," + FileName + "," + Function + "," + IError + Line;
            IntPtr ptr = Marshal.StringToHGlobalAnsi(strSend);
            COPYDATASTRUCT cds = new COPYDATASTRUCT();
            cds.dwData = IntPtr.Zero;
            cds.cbData = strSend.Length;
        ...
        /// <param name="line"></param>
        /// <param name="caller"></param>
        public static void SendLog<T>(T Page, string log, Exception e = null, [CallerFilePath] string FileName = null ,[CallerLineNumber] int line = 0, [CallerMemberName] string caller = null)
        {
            StackFrame[] sfs = st.GetFrames();
            ...
            IntPtr maindHwnd = FindWindow(null, "SJLog");
            string strSend = Page.ToString() + "," + log + ","  + FileName  + "," + Function + "," + IError + Line + Page.ToString() + "," + log + "," + FileName + "," + Function + "," + IError + Line;
            IntPtr ptr = Marshal.StringToHGlobalAnsi(strSend);
            COPYDATASTRUCT cds = new COPYDATASTRUCT();
            cds.dwData = IntPtr.Zero;
            cds.cbData = strSend.Length;
